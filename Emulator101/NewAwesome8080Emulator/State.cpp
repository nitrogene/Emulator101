...
{
	std::string flags = this->Flags.toString();
	auto f = this->Flags.getF();
	...
	return fmt::format("af      bc      de      hl      pc      sp      flags   cycles  steps\n{0:02x}{1:02x}\t{2:02x}{3:02x}\t{4:02x}{5:02x}\t{6:02x}{7:02x}\t{8:04x}\t{9:04x}\t{10}\t{11:06}\t{12:06}\n", 
		this->A, f,this->B,this->C,this->D,this->E, this->H, this->L,this->PC,this->SP, flags,this->Cycles,this->Steps);
}
